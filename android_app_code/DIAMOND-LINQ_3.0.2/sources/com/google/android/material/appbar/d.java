...
abstract class d<V extends View> extends f<V> {
    ...
    private class a implements Runnable {
        ...
        private final CoordinatorLayout f1440a;
        ...
        public void run() {
            ...
            if (this.f1441b != null && (overScroller = d.this.e) != null) {
                if (overScroller.computeScrollOffset()) {
                    d dVar = d.this;
                    dVar.c(this.f1440a, this.f1441b, dVar.e.getCurrY());
                    y.a((View) this.f1441b, (Runnable) this);
                    return;
                }
                d.this.e(this.f1440a, this.f1441b);
            }
        }
    }
    ...
    public boolean a(androidx.coordinatorlayout.widget.CoordinatorLayout r5, V r6, android.view.MotionEvent r7) {
        ...
        L_0x008a:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.appbar.d.a(androidx.coordinatorlayout.widget.CoordinatorLayout, android.view.View, android.view.MotionEvent):boolean");
    }
