...
public class d extends ViewGroup {
    ...
    private void a(Context context, AttributeSet attributeSet) {
        ...
        this.f1511a = obtainStyledAttributes.getDimensionPixelSize(j.FlowLayout_lineSpacing, 0);
        this.f1512b = obtainStyledAttributes.getDimensionPixelSize(j.FlowLayout_itemSpacing, 0);
            ...
            for (int i10 = 0; i10 < getChildCount(); i10++) {
                ...
                if (childAt.getVisibility() != 8) {
                    ...
                    if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
                        ...
                        i5 = C0042f.b(marginLayoutParams);
                        i6 = C0042f.a(marginLayoutParams);
                    } else {
                        i6 = 0;
                        i5 = 0;
                    }
                    ...
                    i8 += i5 + i6 + childAt.getMeasuredWidth() + this.f1512b;
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                int measuredWidth2 = i13 + i4 + i3 + childAt.getMeasuredWidth() + this.f1512b;
