...
public class SwipeRefreshLayout extends ViewGroup implements o, k {
    ...
    private static final String f1003a = "SwipeRefreshLayout";

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f1004b = {16842766};
    protected int A;
    int B;
    int C;
    d D;
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    int i2 = this.s;
                    if (i2 == -1) {
                        Log.e(f1003a, "Got ACTION_MOVE event but don't have an active pointer id.");
                        return false;
                    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (findPointerIndex < 0) {
                Log.e(f1003a, "Got ACTION_UP event but don't have an active pointer id.");
                return false;
            }
            if (this.r) {
                this.r = false;
            ...
            int findPointerIndex2 = motionEvent.findPointerIndex(this.s);
            if (findPointerIndex2 < 0) {
                Log.e(f1003a, "Got ACTION_MOVE event but have an invalid active pointer id.");
                return false;
            }
            ...
            if (actionMasked == 5) {
                ...
                if (actionIndex < 0) {
                    Log.e(f1003a, "Got ACTION_POINTER_DOWN event but have an invalid action index.");
                    return false;
                }
    ...
    public void setColorSchemeResources(int... iArr) {
        ...
        for (int i2 = 0; i2 < iArr.length; i2++) {
            iArr2[i2] = a.g.a.a.a(context, iArr[i2]);
        }
    ...
    public void setProgressBackgroundColorSchemeResource(int i2) {
        setProgressBackgroundColorSchemeColor(a.g.a.a.a(getContext(), i2));
    }
    ...
    public void setSize(int i2) {
        if (i2 == 0 || i2 == 1) {
            ...
            this.w.setImageDrawable((Drawable) null);
            this.D.a(i2);
            this.w.setImageDrawable(this.D);
        }
    }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.A = i2;
        a(1.0f);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f1004b);
