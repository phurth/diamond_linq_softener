...
public class d extends Drawable implements Animatable {
    ...
    private static final Interpolator f1013a = new LinearInterpolator();

    /* renamed from: b  reason: collision with root package name */
    private static final Interpolator f1014b = new b();
    ...
    private static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        final RectF f1015a = new RectF();

        /* renamed from: b  reason: collision with root package name */
        final Paint f1016b = new Paint();
        ...
        a() {
            this.f1016b.setStrokeCap(Paint.Cap.SQUARE);
        ...
        public void a(Canvas canvas, Rect rect) {
            ...
            this.f1016b.setColor(this.u);
            this.f1016b.setAlpha(this.t);
            float f8 = this.h / 2.0f;
            rectF.inset(f8, f8);
            canvas.drawCircle(rectF.centerX(), rectF.centerY(), rectF.width() / 2.0f, this.d);
            float f9 = -f8;
            rectF.inset(f9, f9);
            canvas.drawArc(rectF, f6, f7, false, this.f1016b);
        ...
        public void a(ColorFilter colorFilter) {
            this.f1016b.setColorFilter(colorFilter);
        }
    ...
    public void a(float f2, a aVar, boolean z) {
        ...
        if (this.i) {
            ...
            if (f2 < 0.5f) {
                float i2 = aVar.i();
                float f5 = i2;
                f3 = (f1014b.getInterpolation(f2 / 0.5f) * 0.79f) + 0.01f + i2;
                f4 = f5;
            } else {
                f3 = aVar.i() + 0.79f;
                f4 = f3 - (((1.0f - f1014b.getInterpolation((f2 - 0.5f) / 0.5f)) * 0.79f) + 0.01f);
            }
            aVar.e(f4);
            aVar.c(f3);
    ...
    private void a() {
        ...
        ofFloat.setInterpolator(f1013a);
