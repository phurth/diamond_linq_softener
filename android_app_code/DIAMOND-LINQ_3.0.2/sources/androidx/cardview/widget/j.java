...
class j extends Drawable {
    ...
    private static final double f671a = Math.cos(Math.toRadians(45.0d));
    ...
    j(Resources resources, ColorStateList colorStateList, float f2, float f3, float f4) {
        ...
        this.c = resources.getDimensionPixelSize(c.cardview_compat_inset_shadow);
        this.d = new Paint(5);
        b(colorStateList);
        this.e = new Paint(5);
    ...
    public void draw(Canvas canvas) {
        ...
        a(canvas);
        canvas.translate(0.0f, (-this.l) / 2.0f);
        f672b.a(canvas, this.g, this.h, this.d);
    }
