...
class C0164o extends RecyclerView.h implements RecyclerView.m {

    /* renamed from: a  reason: collision with root package name */
    private static final int[] f979a = {16842919};

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f980b = new int[0];
    private final int[] A = new int[2];
    final ValueAnimator B = ValueAnimator.ofFloat(new float[]{0.0f, 1.0f});
    int C = 0;
    private final Runnable D = new C0162m(this);
    private final RecyclerView.n E = new C0163n(this);
    private final int c;
    private final int d;
    ...
    private class a extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            if (this.f981a) {
                this.f981a = false;
            } else if (((Float) C0164o.this.B.getAnimatedValue()).floatValue() == 0.0f) {
                C0164o oVar = C0164o.this;
                oVar.C = 0;
                oVar.b(0);
            } else {
                C0164o oVar2 = C0164o.this;
                oVar2.C = 2;
                oVar2.a();
            }
        }
    ...
    private class b implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            C0164o.this.e.setAlpha(floatValue);
            C0164o.this.f.setAlpha(floatValue);
            C0164o.this.a();
        }
    }

    C0164o(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i2, int i3, int i4) {
