...
class u {
    ...
    interface a {
        C0150a.b a(int i, int i2, int i3, Object obj);

        void a(C0150a.b bVar);
    }
    ...
    private void c(List<C0150a.b> list, int i, C0150a.b bVar, int i2, C0150a.b bVar2) {
        int i3 = bVar.d < bVar2.f950b ? -1 : 0;
        if (bVar.f950b < bVar2.f950b) {
            i3++;
        }
        int i4 = bVar2.f950b;
        int i5 = bVar.f950b;
        if (i4 <= i5) {
            bVar.f950b = i5 + bVar2.d;
        }
        int i6 = bVar2.f950b;
        int i7 = bVar.d;
        if (i6 <= i7) {
    ...
    public void a(List<C0150a.b> list) {
        while (true) {
            int b2 = b(list);
            if (b2 != -1) {
                a(list, b2, b2 + 1);
    ...
    public void b(java.util.List<androidx.recyclerview.widget.C0150a.b> r9, int r10, androidx.recyclerview.widget.C0150a.b r11, int r12, androidx.recyclerview.widget.C0150a.b r13) {
        /*
            r8 = this;
            int r0 = r11.d
            int r1 = r13.f950b
        ...
        L_0x000d:
            ...
            int r5 = r5 - r4
            r13.d = r5
            androidx.recyclerview.widget.u$a r0 = r8.f992a
            int r1 = r11.f950b
        ...
        L_0x002b:
            ...
            int r5 = r5 + r6
            int r5 = r5 - r1
            androidx.recyclerview.widget.u$a r3 = r8.f992a
            int r1 = r1 + r4
        ...
        L_0x004c:
            r9.remove(r10)
            androidx.recyclerview.widget.u$a r11 = r8.f992a
            r11.a(r13)
        L_0x0054:
    ...
    private void a(List<C0150a.b> list, int i, int i2) {
        C0150a.b bVar = list.get(i);
        C0150a.b bVar2 = list.get(i2);
        int i3 = bVar2.f949a;
        if (i3 == 1) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void a(java.util.List<androidx.recyclerview.widget.C0150a.b> r10, int r11, androidx.recyclerview.widget.C0150a.b r12, int r13, androidx.recyclerview.widget.C0150a.b r14) {
        /*
            r9 = this;
            int r0 = r12.f950b
            int r1 = r12.d
        ...
        L_0x002f:
            ...
            r10.remove(r13)
            androidx.recyclerview.widget.u$a r10 = r9.f992a
            r10.a(r14)
        L_0x0047:
            return
        L_0x0048:
        ...
        L_0x0053:
            ...
            int r4 = r4 + r7
            int r4 = r4 - r1
            androidx.recyclerview.widget.u$a r7 = r9.f992a
            int r1 = r1 + r3
    ...
    private int b(List<C0150a.b> list) {
        boolean z = false;
        for (int size = list.size() - 1; size >= 0; size--) {
            if (list.get(size).f949a != 8) {
                z = true;
            } else if (z) {
                return size;
            }
