...
class H {
    ...
    static H a(Context context) {
        if (f394a == null) {
            ...
            f394a = new H(applicationContext, (LocationManager) applicationContext.getSystemService("location"));
        }
        return f394a;
    }
    ...
    private Location b() {
        ...
        Location a2 = b.a(this.f395b, "android.permission.ACCESS_COARSE_LOCATION") == 0 ? a("network") : null;
        if (b.a(this.f395b, "android.permission.ACCESS_FINE_LOCATION") == 0) {
            location = a("gps");
        }
