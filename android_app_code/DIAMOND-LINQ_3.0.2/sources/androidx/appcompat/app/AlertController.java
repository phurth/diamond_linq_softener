...
class AlertController {
    ...
    private int Q = 0;
    Handler R;
    private final View.OnClickListener S = new C0073c(this);
    ...
    public static class RecycleListView extends ListView {
        ...
        public void a(boolean z, boolean z2) {
            if (!z2 || !z) {
                setPadding(getPaddingLeft(), z ? getPaddingTop() : this.f373a, getPaddingRight(), z2 ? getPaddingBottom() : this.f374b);
            }
        }
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            this.f374b = obtainStyledAttributes.getDimensionPixelOffset(j.RecycleListView_paddingBottomNoButtons, -1);
            this.f373a = obtainStyledAttributes.getDimensionPixelOffset(j.RecycleListView_paddingTopNoTitle, -1);
        }
    }
    ...
    public static class a {
        ...
        /* renamed from: b  reason: collision with root package name */
        public final LayoutInflater f376b;
        public int c = 0;
        public Drawable d;
        public int e = 0;
        ...
        public a(Context context) {
            this.f375a = context;
            this.r = true;
            this.f376b = (LayoutInflater) context.getSystemService("layout_inflater");
        }
        ...
        private void b(androidx.appcompat.app.AlertController r12) {
            /*
                r11 = this;
                android.view.LayoutInflater r0 = r11.f376b
                int r1 = r12.L
                r2 = 0
                ...
                android.content.Context r3 = r11.f375a
                int r4 = r12.M
            ...
            L_0x005e:
                ...
                android.content.Context r2 = r11.f375a
    ...
    private static final class b extends Handler {
        ...
        /* renamed from: a  reason: collision with root package name */
        private WeakReference<DialogInterface> f377a;
        ...
        public void handleMessage(Message message) {
            int i = message.what;
            if (i == -3 || i == -2 || i == -1) {
                ((DialogInterface.OnClickListener) message.obj).onClick((DialogInterface) this.f377a.get(), message.what);
            } else if (i == 1) {
    ...
    private void d() {
        ...
        View findViewById;
        View findViewById2;
        View findViewById3 = this.c.findViewById(f.parentPanel);
    ...
    private void c(ViewGroup viewGroup) {
        ...
        boolean z2 = false;
        if (view == null) {
            view = this.i != 0 ? LayoutInflater.from(this.f371a).inflate(this.i, viewGroup, false) : null;
        }
        if (view != null) {
            z2 = true;
        }
        ...
        if (z2) {
            ...
            if (this.g != null) {
                ((W.a) viewGroup.getLayoutParams()).f570a = 0.0f;
                return;
            }
            return;
        }
    ...
    private void b(ViewGroup viewGroup) {
        this.A = (NestedScrollView) this.c.findViewById(f.scrollView);
    ...
    public int a(int i2) {
        TypedValue typedValue = new TypedValue();
        this.f371a.getTheme().resolveAttribute(i2, typedValue, true);
    ...
    private void d(ViewGroup viewGroup) {
        ...
        this.E = (TextView) this.c.findViewById(f.alertTitle);
    ...
    private void a(ViewGroup viewGroup, View view, int i2, int i3) {
        ...
        if (findViewById != null || view2 != null) {
            if (this.f != null) {
                this.A.setOnScrollChangeListener(new C0074d(this, findViewById, view2));
                this.A.post(new C0075e(this, findViewById, view2));
                return;
            }
            ListView listView = this.g;
            if (listView != null) {
                listView.setOnScrollListener(new C0076f(this, findViewById, view2));
                this.g.post(new C0077g(this, findViewById, view2));
                return;
            }
            if (findViewById != null) {
                viewGroup.removeView(findViewById);
