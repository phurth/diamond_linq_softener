...
class ta extends c implements View.OnClickListener {
    ...
    private static final class a {
        ...
        public a(View view) {
            this.f640a = (TextView) view.findViewById(16908308);
            this.f641b = (TextView) view.findViewById(16908309);
    ...
    public ta(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap<String, Drawable.ConstantState> weakHashMap) {
    ...
    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (a2 != null) {
                ((a) a2.getTag()).f640a.setText(e.toString());
            }
            return a2;
        }
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (b2 != null) {
                ((a) b2.getTag()).f640a.setText(e.toString());
            }
            return b2;
        }
    }
    ...
    private CharSequence b(CharSequence charSequence) {
        if (this.t == null) {
            ...
            this.d.getTheme().resolveAttribute(a.a.a.textColorSearchUrl, typedValue, true);
    ...
    private Drawable b(String str) {
        ...
        try {
            ...
            Drawable c = a.g.a.a.c(this.o, parseInt);
            a(str2, c);
            return c;
    ...
    public void a(View view, Context context, Cursor cursor) {
        ...
        if (aVar.f640a != null) {
            a(aVar.f640a, (CharSequence) a(cursor, this.u));
        }
        if (aVar.f641b != null) {
            ...
            if (TextUtils.isEmpty(charSequence)) {
                TextView textView = aVar.f640a;
                if (textView != null) {
                    textView.setSingleLine(false);
                    aVar.f640a.setMaxLines(2);
                }
            } else {
                TextView textView2 = aVar.f640a;
                if (textView2 != null) {
                    textView2.setSingleLine(true);
                    aVar.f640a.setMaxLines(1);
                }
            }
            a(aVar.f641b, charSequence);
        }
        ...
        if (i3 == 2 || (i3 == 1 && (i2 & 1) != 0)) {
            ...
            aVar.e.setTag(aVar.f640a.getText());
    ...
    private android.graphics.drawable.Drawable b(android.net.Uri r7) {
        ...
        L_0x0085:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.ta.b(android.net.Uri):android.graphics.drawable.Drawable");
    }
    ...
    public Cursor a(SearchableInfo searchableInfo, String str, int i) {
        ...
        Uri.Builder fragment = new Uri.Builder().scheme(LogContract.Session.Content.CONTENT).authority(suggestAuthority).query(BuildConfig.FLAVOR).fragment(BuildConfig.FLAVOR);
