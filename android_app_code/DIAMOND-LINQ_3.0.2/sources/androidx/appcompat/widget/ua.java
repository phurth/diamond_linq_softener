...
class ua {
    ...
    private static final ThreadLocal<TypedValue> f644a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    static final int[] f645b = {-16842910};
    ...
    public static int a(Context context, int i2) {
        ...
        if (c2 != null && c2.isStateful()) {
            return c2.getColorForState(f645b, c2.getDefaultColor());
        }
        TypedValue a2 = a();
    ...
    public static int b(Context context, int i2) {
        int[] iArr = j;
        iArr[0] = i2;
        za a2 = za.a(context, (AttributeSet) null, iArr);
        try {
            return a2.a(0, 0);
        } finally {
            a2.a();
    ...
    private static TypedValue a() {
        TypedValue typedValue = f644a.get();
        if (typedValue != null) {
            return typedValue;
        }
        TypedValue typedValue2 = new TypedValue();
        f644a.set(typedValue2);
        return typedValue2;
    }
