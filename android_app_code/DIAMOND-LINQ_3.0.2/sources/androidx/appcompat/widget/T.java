...
class T extends ListView {
    ...
    private final Rect f551a = new Rect();
    ...
    public boolean a(android.view.MotionEvent r8, int r9) {
        ...
        L_0x006c:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.T.a(android.view.MotionEvent, int):boolean");
    }
    ...
    private void a(Canvas canvas) {
        Drawable selector;
        if (!this.f551a.isEmpty() && (selector = getSelector()) != null) {
            selector.setBounds(this.f551a);
