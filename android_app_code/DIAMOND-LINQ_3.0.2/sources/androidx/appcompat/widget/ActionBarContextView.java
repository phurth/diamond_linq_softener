...
public class ActionBarContextView extends C0085a {
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (view == null || view.getVisibility() == 8) {
            ...
            int a3 = C0085a.a(paddingRight, i7, a2);
            i6 = C0085a.a(a3 + a(this.k, a3, paddingTop, paddingTop2, a2), i8, a2);
        }
        LinearLayout linearLayout = this.m;
    ...
    public void a(b bVar) {
        ...
        this.k.findViewById(f.action_mode_close_button).setOnClickListener(new C0089c(this, bVar));
        k kVar = (k) bVar.c();
        C0097g gVar = this.d;
        if (gVar != null) {
            gVar.d();
        }
        this.d = new C0097g(getContext());
        this.d.c(true);
        ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams(-2, -1);
        kVar.a((t) this.d, this.f582b);
        this.c = (ActionMenuView) this.d.b((ViewGroup) this);
        y.a((View) this.c, (Drawable) null);
        addView(this.c, layoutParams);
    }

    public ActionBarContextView(Context context, AttributeSet attributeSet, int i2) {
        super(context, attributeSet, i2);
        za a2 = za.a(context, attributeSet, j.ActionMode, i2, 0);
