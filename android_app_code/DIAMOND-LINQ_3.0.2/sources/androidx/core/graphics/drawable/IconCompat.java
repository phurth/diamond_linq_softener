...
public class IconCompat extends CustomVersionedParcelable {
    ...
    static final PorterDuff.Mode f732a = PorterDuff.Mode.SRC_IN;
    ...
    public int a() {
        if (this.f733b == -1 && Build.VERSION.SDK_INT >= 23) {
    ...
    public java.lang.String toString() {
        ...
        L_0x00a8:
            ...
            android.graphics.PorterDuff$Mode r2 = f732a
