...
public final class z {
    ...
    private static Method f240a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f240a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    private static float d(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f240a) != null) {
            try {
