...
class d extends j {
    ...
    private static Class f140b = null;
    ...
    private static Typeface a(Object obj) {
        a();
        try {
            Object newInstance = Array.newInstance(f140b, 1);
    ...
    public android.graphics.Typeface a(android.content.Context r5, android.os.CancellationSignal r6, a.g.f.f.b[] r7, int r8) {
        /*
            r4 = this;
            int r0 = r7.length
            r1 = 0
            ...
            return r1
        L_0x0006:
            a.g.f.f$b r7 = r4.a((a.g.f.f.b[]) r7, (int) r8)
        ...
        L_0x007f:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: a.g.b.d.a(android.content.Context, android.os.CancellationSignal, a.g.f.f$b[], int):android.graphics.Typeface");
    }
