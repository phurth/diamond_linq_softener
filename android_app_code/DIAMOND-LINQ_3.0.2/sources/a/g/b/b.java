...
public class b {
    ...
    public static class C0004b {
        ...
        C0004b(char c, float[] fArr) {
            this.f136a = c;
            this.f137b = fArr;
        }

        public static void a(C0004b[] bVarArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < bVarArr.length; i++) {
                a(path, fArr, c, bVarArr[i].f136a, bVarArr[i].f137b);
                c = bVarArr[i].f136a;
            }
        }
        ...
        C0004b(C0004b bVar) {
            ...
            float[] fArr = bVar.f137b;
            this.f137b = b.a(fArr, 0, fArr.length);
        }

        public void a(C0004b bVar, C0004b bVar2, float f) {
            this.f136a = bVar.f136a;
            int i = 0;
            while (true) {
                float[] fArr = bVar.f137b;
                if (i < fArr.length) {
                    this.f137b[i] = (fArr[i] * (1.0f - f)) + (bVar2.f137b[i] * f);
                    i++;
                } else {
                    return;
                }
    ...
    public static void b(C0004b[] bVarArr, C0004b[] bVarArr2) {
        for (int i = 0; i < bVarArr2.length; i++) {
            bVarArr[i].f136a = bVarArr2[i].f136a;
            for (int i2 = 0; i2 < bVarArr2[i].f137b.length; i2++) {
                bVarArr[i].f137b[i2] = bVarArr2[i].f137b[i2];
            }
        }
    }
    ...
    public static C0004b[] a(String str) {
        ...
        while (i < str.length()) {
            ...
            if (trim.length() > 0) {
                a((ArrayList<C0004b>) arrayList, trim.charAt(0), c(trim));
            }
            i2 = a2;
            i = a2 + 1;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            a((ArrayList<C0004b>) arrayList, str.charAt(i2), new float[0]);
        }
        return (C0004b[]) arrayList.toArray(new C0004b[arrayList.size()]);
    }

    public static C0004b[] a(C0004b[] bVarArr) {
        if (bVarArr == null) {
            return null;
        }
        C0004b[] bVarArr2 = new C0004b[bVarArr.length];
        for (int i = 0; i < bVarArr.length; i++) {
            bVarArr2[i] = new C0004b(bVarArr[i]);
        }
        return bVarArr2;
    }

    public static boolean a(C0004b[] bVarArr, C0004b[] bVarArr2) {
        if (bVarArr == null || bVarArr2 == null || bVarArr.length != bVarArr2.length) {
            return false;
        }
        for (int i = 0; i < bVarArr.length; i++) {
            if (bVarArr[i].f136a != bVarArr2[i].f136a || bVarArr[i].f137b.length != bVarArr2[i].f137b.length) {
                return false;
            }
        }
        return true;
    ...
    private static void a(ArrayList<C0004b> arrayList, char c, float[] fArr) {
        arrayList.add(new C0004b(c, fArr));
    }
    ...
    private static void a(java.lang.String r8, int r9, a.g.b.b.a r10) {
        /*
            r0 = 0
            r10.f135b = r0
            r1 = r9
        ...
        L_0x003d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: a.g.b.b.a(java.lang.String, int, a.g.b.b$a):void");
    }
}
