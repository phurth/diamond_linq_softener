...
public final class a {
    ...
    static final d f169a = e.c;

    /* renamed from: b  reason: collision with root package name */
    private static final String f170b = Character.toString(8206);
    private static final String c = Character.toString(8207);
    static final a d = new a(false, 2, f169a);
    static final a e = new a(true, 2, f169a);
    ...
    public static final class C0005a {
        ...
        public a a() {
            if (this.f172b == 2 && this.c == a.f169a) {
                return a(this.f171a);
            }
            return new a(this.f171a, this.f172b, this.c);
        }
    }
    ...
    private static class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        private static final byte[] f173a = new byte[1792];
        ...
        static {
            for (int i = 0; i < 1792; i++) {
                f173a[i] = Character.getDirectionality(i);
            }
        }
        ...
        private static byte a(char c2) {
            return c2 < 1792 ? f173a[c2] : Character.getDirectionality(c2);
        }
        ...
        private byte e() {
            ...
            do {
                ...
                CharSequence charSequence = this.f174b;
                int i3 = i2 - 1;
                this.e = i3;
            ...
            while (true) {
                ...
                if (c2 == '>') {
                    ...
                    do {
                        ...
                        CharSequence charSequence2 = this.f174b;
                        int i5 = i4 - 1;
                        this.e = i5;
        ...
        public byte b() {
            this.f = this.f174b.charAt(this.e);
            if (Character.isHighSurrogate(this.f)) {
                int codePointAt = Character.codePointAt(this.f174b, this.e);
        ...
        public int d() {
            ...
            L_0x003b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: a.g.g.a.b.d():int");
        }

        /* access modifiers changed from: package-private */
        public byte a() {
            this.f = this.f174b.charAt(this.e - 1);
            if (Character.isLowSurrogate(this.f)) {
                int codePointBefore = Character.codePointBefore(this.f174b, this.e);
    ...
    private String a(CharSequence charSequence, d dVar) {
        ...
        if (this.f) {
            return (!isRtl || c(charSequence) == -1) ? c : BuildConfig.FLAVOR;
        }
    ...
    private String b(CharSequence charSequence, d dVar) {
        ...
        if (this.f) {
            return (!isRtl || b(charSequence) == -1) ? c : BuildConfig.FLAVOR;
        }
        return BuildConfig.FLAVOR;
    }
    ...
    public CharSequence a(CharSequence charSequence, d dVar, boolean z) {
        ...
        if (b() && z) {
            spannableStringBuilder.append(b(charSequence, isRtl ? e.f184b : e.f183a));
        }
        if (isRtl != this.f) {
        ...
        if (z) {
            spannableStringBuilder.append(a(charSequence, isRtl ? e.f184b : e.f183a));
        }
