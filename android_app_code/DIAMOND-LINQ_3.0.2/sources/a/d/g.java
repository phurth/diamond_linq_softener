...
public class g<K, V> {
    ...
    private final LinkedHashMap<K, V> f58a;
    ...
    public g(int i) {
        if (i > 0) {
            this.c = i;
            this.f58a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    public final V b(K r5) {
        /*
            ...
            monitor-enter(r4)
            java.util.LinkedHashMap<K, V> r0 = r4.f58a     // Catch:{ all -> 0x0051 }
        ...
        L_0x0022:
            ...
            java.util.LinkedHashMap<K, V> r1 = r4.f58a     // Catch:{ all -> 0x004e }
            java.lang.Object r1 = r1.put(r5, r0)     // Catch:{ all -> 0x004e }
            if (r1 == 0) goto L_0x0037
            java.util.LinkedHashMap<K, V> r2 = r4.f58a     // Catch:{ all -> 0x004e }
            r2.put(r5, r1)     // Catch:{ all -> 0x004e }
            goto L_0x0040
        L_0x0037:
            int r2 = r4.f59b     // Catch:{ all -> 0x004e }
            int r3 = r4.c(r5, r0)     // Catch:{ all -> 0x004e }
            int r2 = r2 + r3
            r4.f59b = r2     // Catch:{ all -> 0x004e }
        L_0x0040:
        ...
        L_0x0054:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: a.d.g.b(java.lang.Object):java.lang.Object");
    }
    ...
    public void a(int r5) {
        ...
        L_0x0000:
            monitor-enter(r4)
            int r0 = r4.f59b     // Catch:{ all -> 0x0071 }
            if (r0 < 0) goto L_0x0052
            java.util.LinkedHashMap<K, V> r0 = r4.f58a     // Catch:{ all -> 0x0071 }
        ...
        L_0x001e:
            ...
            java.util.LinkedHashMap<K, V> r2 = r4.f58a     // Catch:{ all -> 0x0071 }
            r2.remove(r1)     // Catch:{ all -> 0x0071 }
            int r2 = r4.f59b     // Catch:{ all -> 0x0071 }
            int r3 = r4.c(r1, r0)     // Catch:{ all -> 0x0071 }
            int r2 = r2 - r3
            r4.f59b = r2     // Catch:{ all -> 0x0071 }
        ...
        L_0x0071:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: a.d.g.a(int):void");
    }
}
