...
public class j<E> implements Cloneable {
    ...
    public void d(int r4) {
        /*
            ...
            int[] r0 = r3.c
            int r1 = r3.e
            int r4 = a.d.e.a((int[]) r0, (int) r1, (int) r4)
            if (r4 < 0) goto L_0x0017
            java.lang.Object[] r0 = r3.d
            r1 = r0[r4]
            java.lang.Object r2 = f71a
        ...
        L_0x0017:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: a.d.j.d(int):void");
    }
    ...
    public void a(int i, E e2) {
        ...
        if (i2 == 0 || i > this.c[i2 - 1]) {
            if (this.f72b && this.e >= this.c.length) {
                c();
            }
            int i3 = this.e;
            if (i3 >= this.c.length) {
