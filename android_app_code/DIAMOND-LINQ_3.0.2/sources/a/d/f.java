...
public class f<E> implements Cloneable {
    ...
    public void d(long r3) {
        /*
            ...
            long[] r0 = r2.c
            int r1 = r2.e
            int r3 = a.d.e.a((long[]) r0, (int) r1, (long) r3)
            if (r3 < 0) goto L_0x0017
            java.lang.Object[] r4 = r2.d
            r0 = r4[r3]
            java.lang.Object r1 = f56a
        ...
        L_0x0017:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: a.d.f.d(long):void");
    }
    ...
    public void a(long j, E e2) {
        int i = this.e;
        if (i == 0 || j > this.c[i - 1]) {
            if (this.f57b && this.e >= this.c.length) {
                c();
            }
            int i2 = this.e;
            if (i2 >= this.c.length) {
