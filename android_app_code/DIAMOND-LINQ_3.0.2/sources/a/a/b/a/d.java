...
class d extends Drawable implements Drawable.Callback {
    ...
    static class a implements Drawable.Callback {
        ...
        /* renamed from: a  reason: collision with root package name */
        private Drawable.Callback f13a;
        ...
        public void scheduleDrawable(Drawable drawable, Runnable runnable, long j) {
            Drawable.Callback callback = this.f13a;
            if (callback != null) {
    ...
    static abstract class b extends Drawable.ConstantState {
        ...
        b(b bVar, d dVar, Resources resources) {
            ...
            if (resources != null) {
                ...
                resources2 = bVar != null ? bVar.f15b : null;
            }
            this.f15b = resources2;
            this.c = d.a(resources, bVar != null ? bVar.c : 0);
            if (bVar != null) {
                this.d = bVar.d;
                this.e = bVar.e;
                this.v = true;
        ...
        private void n() {
            ...
            if (sparseArray != null) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    this.g[this.f.keyAt(i2)] = b(this.f.valueAt(i2).newDrawable(this.f15b));
                }
                this.f = null;
            }
        }
        ...
        public final int a(Drawable drawable) {
            ...
            drawable.setCallback(this.f14a);
            this.g[i2] = drawable;
            this.h++;
        ...
        public final Drawable a(int i2) {
            ...
            Drawable b2 = b(this.f.valueAt(indexOfKey).newDrawable(this.f15b));
            this.g[i2] = b2;
    ...
    public boolean a(int r9) {
        ...
        L_0x007f:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: a.a.b.a.d.a(int):boolean");
    }
    ...
    public int getChangingConfigurations() {
        return super.getChangingConfigurations() | this.f11a.getChangingConfigurations();
    }
    ...
    public final Drawable.ConstantState getConstantState() {
        ...
        this.f11a.d = getChangingConfigurations();
        return this.f11a;
    }
    ...
    public void setHotspotBounds(int i2, int i3, int i4, int i5) {
        Rect rect = this.f12b;
        if (rect == null) {
            this.f12b = new Rect(i2, i3, i4, i5);
        } else {
    ...
    private void a(Drawable drawable) {
        ...
        try {
            if (this.f11a.A <= 0 && this.f) {
                drawable.setAlpha(this.e);
            }
            if (this.f11a.E) {
                drawable.setColorFilter(this.f11a.D);
            } else {
                if (this.f11a.H) {
                    androidx.core.graphics.drawable.a.a(drawable, this.f11a.F);
                }
                if (this.f11a.I) {
                    androidx.core.graphics.drawable.a.a(drawable, this.f11a.G);
                }
            }
            drawable.setVisible(isVisible(), true);
            drawable.setDither(this.f11a.x);
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                drawable.setAutoMirrored(this.f11a.C);
            }
            Rect rect = this.f12b;
    ...
    public void a(boolean r14) {
        ...
        L_0x0077:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: a.a.b.a.d.a(boolean):void");
    }

    /* access modifiers changed from: package-private */
    public final void a(Resources resources) {
        this.f11a.a(resources);
    }
