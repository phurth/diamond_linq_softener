...
class d {
    ...
    private static class c<T> implements Comparator<T> {
        ...
        private final Rect f249a = new Rect();

        /* renamed from: b  reason: collision with root package name */
        private final Rect f250b = new Rect();
    ...
    private static boolean b(int i, Rect rect, Rect rect2, Rect rect3) {
        ...
        if (!a(i, rect, rect3, rect2) && a(c(i, rect, rect2), g(i, rect, rect2)) < a(c(i, rect, rect3), g(i, rect, rect3))) {
            return true;
        }
        return false;
    }
