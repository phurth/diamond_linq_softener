...
public class g {
    ...
    private static final Interpolator f252a = new e();
    ...
    private g(Context context, ViewGroup viewGroup, a aVar) {
        if (viewGroup == null) {
            ...
            this.r = new OverScroller(context, f252a);
        } else {
    ...
    public boolean b(View view, int i2, int i3) {
        ...
        if (!b2 && this.f253b == 0 && this.t != null) {
            this.t = null;
        }
        return b2;
    }
    ...
    public boolean b(android.view.MotionEvent r17) {
        ...
        L_0x013a:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: a.i.b.g.b(android.view.MotionEvent):boolean");
    }
    ...
    public void a(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 3) {
                ...
                if (this.f253b == 1 && pointerId3 == this.d) {
                    int pointerCount = motionEvent.getPointerCount();
                    while (true) {
                        if (i3 >= pointerCount) {
                            i2 = -1;
